<?php 
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') {
      ...
      $Hobi = $_POST['Hobi'];
      //query SQL
      $query = "INSERT INTO datamahasiswa (Nama, Jurusan, NPM, JenisKelamin, TTL, PerguruanTinggi, Alamat, Pekerjaan, Hobi) VALUES('$Nama','$Jurusan','$NPM', '$JenisKelamin','$TTL','$PerguruanTinggi','$Alamat','$Pekerjaan','$Hobi')"; 
